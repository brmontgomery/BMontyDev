...
<br />
![Jekyll Site Picture](\assets\images\2_Jekyll-Site.JPG){:.image.centered}
...
### What is Markdown
![Markdown Logo](\assets\images\2_Markdown-mark.jpg){:.image.centered}
...
![Ruby Installer Download](\assets\images\2_Ruby_Installer_Download.jpg){:.image.centered}
2. Keep all options selected during the install. 
![Ruby Installer Options](\assets\images\2_Ruby-Install-Options.jpg){:.image.centered}
...
![Ruby Installer Options](\assets\images\2_Toolset-Install.jpg){:.image.centered}
...
![Ruby Installer Download](\assets\images\2_Serve-Success.jpg){:.image.centered}
...
![Adding Images Properly](\assets\images\2_Image-Adding.jpg){:.image.centered}
...
![Layout Code](\assets\images\2_Layout-Code.jpg){:.image.centered}
![Showing the New Blog Page](\assets\images\2_Jekyll-Blog-1.jpg){:.image.centered}
